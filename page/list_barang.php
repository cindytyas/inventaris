    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="tambah_barang d-flex justify-content-between mb-2" >
                <a href="?p=tambah_barang" class="btn btn-md mb-2 text-white" style="background-color: #7FB3D5;">Tambah Barang</a>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="?p=edit_barang&id_inventaris=<?= $data['id_inventaris'] ?>" class="btn btn-sm text-white" style="background-color: #7FB3D5;">
