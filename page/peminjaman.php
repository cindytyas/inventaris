        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        <button class="btn text-white" style="background-color: #7FB3D5;" name="save">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($data_d['status_peminjaman'] == '0') {
                                        ?>
                                            <a onclick="return confirm('Apakah anda yakin?')" href="page/proses_peminjaman.php?id_peminjaman=<?= $data_d['id_peminjaman'] ?>" class="btn btn-sm text-white" style="background-color: #7FB3D5;">Proses</a>
                                        <?php
                                        }
                                        ?>
                                    </td>
