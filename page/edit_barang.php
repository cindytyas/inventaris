        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        <button class="button btn text-white" style="background-color: #7FB3D5;" name="save" type="submit">Save</button>
                        <a href="?p=list_barang" class="btn text-white" style="background-color: #5DADE2;">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
